...
namespace RMS.Migrations
{
    ...
    [Migration("20240324192349_ApplicationUserStaff")]
    partial class ApplicationUserStaff
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Models.Brand", b =>
                {
                    ...
                    b.HasKey("BrandId")
                        .HasName("PK__brands__5E5A8E273BB2C54D");
            ...
            modelBuilder.Entity("RMS.Models.Category", b =>
                {
                    ...
                    b.HasKey("CategoryId")
                        .HasName("PK__categori__D54EE9B4A1A7C974");

                    b.ToTable("categories", "production");
                });

            modelBuilder.Entity("RMS.Models.Customer", b =>
                {
                    ...
                    b.HasKey("CustomerId")
                        .HasName("PK__customer__CD65CB85196B7BA5");
            ...
            modelBuilder.Entity("RMS.Models.Order", b =>
                {
                    ...
                    b.HasKey("OrderId")
                        .HasName("PK__orders__46596229765FE789");
            ...
            modelBuilder.Entity("RMS.Models.OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderId", "ItemId")
                        .HasName("PK__order_it__837942D495266F68");
            ...
            modelBuilder.Entity("RMS.Models.Product", b =>
                {
                    ...
                    b.HasKey("ProductId")
                        .HasName("PK__products__47027DF50E210C70");
            ...
            modelBuilder.Entity("RMS.Models.Staff", b =>
                {
                    ...
                    b.HasKey("StaffId")
                        .HasName("PK__staffs__1963DD9CF2F8A053");

                    b.HasIndex("ManagerId");

                    b.HasIndex("StoreId");

                    b.HasIndex(new[] { "Email" }, "UQ__staffs__AB6E61644DCE3755")
                        .IsUnique();
            ...
            modelBuilder.Entity("RMS.Models.Stock", b =>
                {
                    ...
                    b.HasKey("StoreId", "ProductId")
                        .HasName("PK__stocks__E68284D394389A60");
            ...
            modelBuilder.Entity("RMS.Models.Store", b =>
                {
                    ...
                    b.HasKey("StoreId")
                        .HasName("PK__stores__A2F2A30C55BC99CA");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RMS.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RMS.Models.ApplicationUser", b =>
                {
                    b.HasOne("RMS.Models.Staff", "Staff")
                        .WithOne("User")
                        .HasForeignKey("RMS.Models.ApplicationUser", "StaffId");
            ...
            modelBuilder.Entity("RMS.Models.Order", b =>
                {
                    b.HasOne("RMS.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RMS.Models.Product", b =>
                {
                    b.HasOne("RMS.Models.Brand", "Brand")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("RMS.Models.Staff", b =>
                {
                    b.HasOne("RMS.Models.Staff", "Manager")
